...
from .views import api_automobile_VO, api_automobile_VOs, api_customers, api_sales_persons, api_sales_records
...
urlpatterns = [
    ...
    path("automobileVOs/<vin>/", api_automobile_VO, name="api_automobile_VO"),
